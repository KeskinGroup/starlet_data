...
tpot_data = pd.read_csv('C:/ReddCOF-Data/Triazine Models/Triazine-2359-N2.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -3.411776903914171e-05
exported_pipeline = ExtraTreesRegressor(bootstrap=False, max_features=0.8, min_samples_leaf=2, min_samples_split=3, n_estimators=100)
