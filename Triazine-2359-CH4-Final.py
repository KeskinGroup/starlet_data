...
tpot_data = pd.read_csv('C:/ReddCOF-Data/Triazine Models/Triazine-2359-CH4.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.00044107504949406534
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=9, min_child_weight=6, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.6500000000000001, verbosity=0)
