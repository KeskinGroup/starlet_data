...
tpot_data = pd.read_csv('C:/ReddCOF-Data/Triazine Models/Triazine-2359-O2.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -3.718119468126516e-05
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    StackingEstimator(estimator=ExtraTreesRegressor(bootstrap=False, max_features=0.8500000000000001, min_samples_leaf=14, min_samples_split=11, n_estimators=100)),
    RandomForestRegressor(bootstrap=True, max_features=0.8500000000000001, min_samples_leaf=3, min_samples_split=3, n_estimators=100)
)
