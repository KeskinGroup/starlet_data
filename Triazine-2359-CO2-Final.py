...
tpot_data = pd.read_csv('C:/ReddCOF-Data/Triazine Models/Triazine-2359-CO2.csv', sep=',', dtype=np.float64)
...
# Average CV score on the training set was: -0.02441203187501001
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=8, min_child_weight=9, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.9000000000000001, verbosity=0)
