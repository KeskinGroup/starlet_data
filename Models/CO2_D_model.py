...
tpot_data = pd.read_csv('CO2_D_model.csv', sep=',', dtype=np.float64)
features = tpot_data.drop('log_D1bar_CO2', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['log_D1bar_CO2'], train_size=0.80, test_size=0.20, random_state=42)

# Average CV score on the training set was: -0.016002670821599094
