...
tpot_data = pd.read_excel('5-FU+MTX_STR_DFT_1BAR.xlsx',dtype=np.float64)
features = tpot_data.drop('drug uptake (g/g)', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['drug uptake (g/g)'],train_size=0.8, test_size=0.2, random_state=42)

# Average CV score on the training set was: -0.004058042761781207
