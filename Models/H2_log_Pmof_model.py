...
tpot_data = pd.read_csv('H2_Pmof_model - log version.csv', sep=',', dtype=np.float64)
features = tpot_data.drop('log_P(H2)', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['log_P(H2)'], train_size=0.80, test_size=0.20, random_state=42)

# Average CV score on the training set was: -0.006926370983548412
