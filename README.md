This is the folder of models developed for the ML study of MOFs for adsorption-based CH4/H2 separation.

.xlsx files contain the input features for MOFs used to build the ML models. The columns represent various structural, chemical, and energetic features of MOFs, and the last column is the target data (e.g., CH4 adsorption at 0.1 bar).
