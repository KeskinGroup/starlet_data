This is the folder of models developed for the ML study of IL/ZIF-8 composites for adsorption-based CO<sub>2</sub>/CH<sub>2</sub> and CO<sub>2</sub>/N<sub>2</sub> separation.
