This is the folder of models developed for the ML study of MOFs for adsorption-based CH<sub>4</sub>/H<sub>2</sub> separation.

.xlsx files contain the input features for MOFs used to build the ML models. The columns represent various structural, chemical, and energetic features of MOFs, and the last column is the target data (e.g., CH<sub>4</sub> adsorption at 0.1 bar).
...
If you utilize the data from this repository, kindly cite it as: https://doi.org/10.1021/acs.jpcc.5c02779
